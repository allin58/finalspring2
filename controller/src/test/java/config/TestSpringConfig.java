...
public class TestSpringConfig implements WebMvcConfigurer {
    ...
    protected JdbcTemplate jdbcTemplate() throws IOException {
      ...
      jdbcTemplate.execute("CREATE TABLE IF NOT EXISTS \"coins\" (\n" +
              ...
              "\n" +
              "CREATE SEQUENCE IF NOT EXISTS order_id_sequence INCREMENT BY 10 START WITH 200;\n" +
               "CREATE SEQUENCE IF NOT EXISTS tansaction_id_sequence INCREMENT BY 10 START WITH 200;\n" +
              "CREATE SEQUENCE IF NOT EXISTS user_id_sequence INCREMENT BY 10 START WITH 200;");
