...
<body>
      ...
      <#assign withdrawUrl = "/wallet?command=withdraw">
...
<div  style="height:100%; background-color: cornsilk">
        ...
        <div class="uui-header navigation-header">
            <nav>
                ...
                <ul class="uui-navigation nav navbar-nav">
                    ...
                    <li> <H2 style = "color: aliceblue" >${usertext} ${user.userName} ${withdraw} </H2></li>
                </ul>
            </nav>
        </div>
    ...
    <div class="uui-login-panel" style = "margin-top : 20% ; margin-left : 40% ; background: #7F993A ">
        ...
        <FORM action="${withdrawUrl}" method="post">
            ...
            <button type="submit" class="uui-button test-color dark-gray" style="margin-top: 20px;width: 100%;">${withdraw} ${coin}</button>
